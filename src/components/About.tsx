...
export default function About() {
  return (
    <section id="about" className="blood-divider min-h-screen py-24 bg-black/35 flex items-center">
        ...
        <div className="max-w-3xl">
          ...
          <div className="flex flex-wrap gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-red-800 hover:bg-red-700 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-red-900/45"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 bg-rose-700 hover:bg-rose-600 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-rose-900/45"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
