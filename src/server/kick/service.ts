...
export async function getKickAccessToken(): Promise<string | null> {
...
export function findLiveFlag(value: unknown, depth = 0): boolean | null {
  ...
  if (typeof value === "object") {
    ...
    const direct = [obj.is_live, obj.isLive, obj.online, obj.is_streaming, obj.livestream, obj.stream, obj.stream_data];
...
export async function fetchKickJson(url: string): Promise<unknown | null> {
